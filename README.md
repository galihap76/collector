# collector
Collector is a tool for osint (open source intelligence) i build this tool for me and you if you want use this tool by the way collector still version beta don't worry i keep develop this tool.
